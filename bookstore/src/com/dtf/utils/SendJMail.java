...
public class SendJMail {
        ...
        static final String password = "gyfitedu";              //发送人的密码
    public static boolean sendMail(String email, String emailMsg) {
       					//发件人的邮件密码

        //定义Properstatic final String from = "15989566325@163.com"; 				// 邮件发送人的邮件地址
        //   static final String to = email; 										// 邮件接收人的邮件地址
        //   static final String username = "15989566325@163.com";  	//发件人的邮件帐户
        //    static final String password = "gyfitedu";
        String to = email;
